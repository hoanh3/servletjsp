              ...
              <div class="card-body"> 
                ...
                <form action="${pageContext.request.contextPath}/admin/admin/add" method="post"> 
                  ...
                  <div class="form-group"> 
                    ...
                    <input type="text" class="form-control" id="input-1" placeholder="Email"  name="admin-email"> 
                  </div> 
                  <div class="form-group"> 
                 ...
                 <div class="form-group"> 
                  ...
                  <div class="form-footer"> 
					          <button class="btn btn-danger"><i class="fa fa-times"></i><a href="${pageContext.request.contextPath}/admin/admin/list">Cancel</a></button>
