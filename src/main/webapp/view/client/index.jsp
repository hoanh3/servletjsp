                            ...
                            <div class="hero__categories">
                                ...
                                <ul>
                                    <c:forEach items="${listCat}" var="cat">
                                        <li class="t-capitalize"><a
                                                href="${pageContext.request.contextPath}/category?catId=${cat.id}">${cat.name}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
                            ...
                            <div class="hero__search">
                                <div class="hero__search__form">
                                    <form action="${pageContext.request.contextPath}/search">
                                        ...
                                        <input type="text" placeholder="What do yo u need?" id="searchStr"
                                            name="searchStr">
                            ...
                            <c:forEach items="${listCat}" var="cat">
                                <div class="col-lg-3">
                                    <div class="categories__item set-bg"
                                        data-setbg="${pageContext.request.contextPath}/view/client/assets/img/categories/${cat.thumbnail}">
                                        <h5><a
                                                href="${pageContext.request.contextPath}/category?catId=${cat.id}">${cat.name}</a>
                                        </h5>
                                    </div>
                                ...
                                <div class="featured__item">
                                    <div class="featured__item__pic set-bg"
                                        ...
                                        <ul class="featured__item__pic__hover">
                                            ...
                                            <li><a
                                                    href="${pageContext.request.contextPath}/addcart?pid=${pro.id}&num=1"><i
                                                        class="fa fa-shopping-cart"></i></a></li>
                                        </ul>
                                    </div>
                                    <div class="featured__item__text">
                                        <h6 class="t-capitalize"><a
                                                href="${pageContext.request.contextPath}/product?pid=${pro.id}">${pro.title}</a>
                                        </h6>
                                        <div class="d-flex">
                                ...
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        <c:forEach items="${topLastest}" var="pro" begin="0" end="2">
                                            <a href="${pageContext.request.contextPath}/product?pid=${pro.id}"
                                                class="latest-product__item">
                                                <div class="latest-product__item__pic">
                                                    <img src="${pageContext.request.contextPath}/view/client/assets/img/product/${pro.thumbnail}"
                                                        alt="">
                                                </div>
